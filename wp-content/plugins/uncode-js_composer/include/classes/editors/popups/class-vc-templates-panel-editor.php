...
class Vc_Templates_Panel_Editor {
	...
	public function getAllTemplates() {
		...
		if ( apply_filters( 'vc_show_user_templates', true ) ) {
			...
			if ( is_array( $user_templates ) ) {
				foreach ( $user_templates as $template_id => $template_data ) {
					...
					// BEGIN UNCODE EDIT
					$category_templates[] = apply_filters( 'uncode_vc_category_templates_args', [
						'unique_id' => $template_id,
		...
		if ( ! empty( $default_templates ) ) {
			// BEGIN UNCODE EDIT
			$arr_category = apply_filters( 'uncode_vc_category_templates_name_args', [
			...
			foreach ( $default_templates as $template_id => $template_data ) {
				...
				// BEGIN UNCODE EDIT
				$category_templates[] = apply_filters( 'uncode_vc_default_category_templates_args', [
					'unique_id' => $template_id,
					'name' => $template_data['name'],
